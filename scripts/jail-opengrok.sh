...
update_motd="NO"
dumpdev="NO"
hostname="opengrok.deiter.local"
ifconfig_opengrok1="inet 172.27.10.23/24"
...
172.27.10.23	opengrok.deiter.local	opengrok
EOF
...
install -v -d -m 0755 -g wheel -o root var/devel/src
install -v -d -m 0755 -g wheel -o root var/devel/src/freebsd
install -v -d -m 0755 -g wheel -o root var/devel/src/nza-kernel
install -v -d -m 0755 -g wheel -o root var/devel/src/allinone
install -v -d -m 0755 -g wheel -o root var/devel/src/remote-rep
